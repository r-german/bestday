...
// Четвёртый слайдер с видео
new Swiper("#video-slider4 .swiper", {
    navigation: {
        prevEl: "#video-slider4 .swiper-btn-prev",
        nextEl: "#video-slider4 .swiper-btn-next"
    },
    freeMode: {
        enabled: true,
        sticky: true
...
// Пятый слайдер с видео
new Swiper("#video-slider5 .swiper", {
    navigation: {
        prevEl: "#video-slider5 .swiper-btn-prev",
        nextEl: "#video-slider5 .swiper-btn-next"
    },
    freeMode: {
        enabled: true,
        sticky: true
